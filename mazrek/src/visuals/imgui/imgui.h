...
namespace ImGui
{
    ...
    IMGUI_API bool          ComboVec(const char* label, int* current_item, std::vector<std::pair<std::string, DWORD>>& items, int items_count, int height_in_items = -1);
	IMGUI_API bool          ComboWithInputSupport(const char* label, const char* preview_text, int* current_item, bool(*items_getter)(void*, int, const char**), void* data, int items_count, int height_in_items);
	...
	IMGUI_API bool          ListBoxVec(const char* label, int* current_item, std::vector<std::pair<std::string, std::string>>& items, int items_count, int height_items);
